...
class Preview extends Component {
  ...
  generateConfig = () => {
    ...
    const filename = 'bitcoingold.conf';
...
function toConf (settings, defaults) {
  ...
  const configPath = joinPath([basePath(platform), 'bitcoingold.conf'], platform);
  conf.unshift(
    '# Generated by https://MentalNomad.github.io/btg-core-config-generator/\n',
